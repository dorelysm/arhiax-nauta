...
test_full_flow_valid_rda_submission if {
...
test_full_flow_blocked_sensitive_without_granular if {
...
consent_with_revocation_fixture := {
	...
	"revocations": {"pat_002": {"timestamp": "2026-04-15T08:00:00Z"}},
	"exclusions": {"pat_002": []},
}
